...
| 15 | Tasks / Appointments | Open reassignment — any circle member (not just the creator) can change the assignee on a task or appointment. Current restriction to creator-only should be lifted. | Medium | — | Not started |
